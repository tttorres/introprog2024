...
Dica: A função index em Perl é utilizada para encontrar a posição de uma substring dentro de uma string. Ela retorna o índice (a posição) da primeira ocorrência da substring encontrada, ou -1 se a substring não estiver presente na string.

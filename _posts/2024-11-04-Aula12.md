...
1. Contar quantas palavras são idênticas nos dois textos.
2. Exibir a lista de palavras comuns e a porcentagem de similaridade entre os textos, com base na quantidade total de palavras de ambos.
...
\[
\text{Similaridade} = \frac{\text{Número de palavras em comum}}{\sqrt{\text{Número de palavras únicas no Texto 1} \times \text{Número de palavras únicas no Texto 2}}}
\]

3. Saída Esperada:

O programa deve imprimir uma lista de palavras compartilhadas e a porcentagem de similaridade entre os textos.
